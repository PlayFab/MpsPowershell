@{
  ...
  FunctionsToExport = 'Enable-PfMultiplayerServer', 'Get-PfArchivedMultiplayerServer', 'Get-PfAssetSummary', 'Get-PfAssetUploadUrl', 'Get-PfBuild', 'Get-PfBuildAlias', 'Get-PfCertificateSummary', 'Get-PfContainerImage', 'Get-PfContainerImageTag', 'Get-PfContainerRegistryCredentials', 'Get-PfMultiplayerServer', 'Get-PfMultiplayerServerLog', 'Get-PfMultiplayerSessionLog', 'Get-PfPartyQosServer', 'Get-PfQosServer', 'Get-PfQueueStatistics', 'Get-PfRemoteLoginEndpoint', 'Get-PfTitleEnabled', 'Get-PfTitleMultiplayerServerQuota', 'Get-PfTitleMultiplayerServerQuotaChange', 'Get-PfVirtualMachineSummary', 'Invoke-PfImageUntagContainer', 'Invoke-PfRolloverContainerRegistryCredentials', 'Invoke-PfUploadCertificate', 'New-Asset', 'New-PfBuild', 'New-PfBuildAlias', 'New-PfRemoteUser', 'New-PfTitleMultiplayerServerQuotaChange', 'Remove-PfAsset', 'Remove-PfBuild', 'Remove-PfBuildAlias', 'Remove-PfBuildRegion', 'Remove-PfCertificate', 'Remove-PfContainerImageRepository', 'Remove-PfRemoteUser', 'Request-PfMultiplayerServer', 'Set-TitleEntityToken', 'Stop-PfMultiplayerServer', 'Update-PfBuildAlias', 'Update-PfBuildName', 'Update-PfBuildRegion', '*'
  AliasesToExport = '*'
  PrivateData = @{
    PSData = @{
      Tags = ''

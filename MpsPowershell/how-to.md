# How-To
This document describes how to develop for `PlayFabMultiplayerApi`.

## Building `PlayFabMultiplayerApi`
...
- `run-module.ps1`
  - Creates an isolated PowerShell session and loads `PlayFabMultiplayerApi` into the session.

...
online version: https://docs.microsoft.com/en-us/powershell/module/playfabmultiplayerapi/get-virtualmachinesummary
schema: 2.0.0
---

# Get-VirtualMachineSummary
...
```
Get-VirtualMachineSummary -BuildId <String> -Region <String> [-CustomTags <IAny>] [-PageSize <Single>]

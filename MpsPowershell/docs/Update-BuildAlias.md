...
online version: https://docs.microsoft.com/en-us/powershell/module/playfabmultiplayerapi/update-buildalias
schema: 2.0.0
---
...
```
Update-BuildAlias -AliasId <String> [-AliasName <String>]

...
online version: https://docs.microsoft.com/en-us/powershell/module/playfabmultiplayerapi/request-multiplayerserver
schema: 2.0.0
---

# Request-MultiplayerServer
...
```
Request-MultiplayerServer -PreferredRegions <String[]> -SessionId <String> [-BuildAliasParamAliasId <String>]
 [-BuildId <String>] [-CustomTags <IAny>] [-InitialPlayers <String[]>] [-SessionCookie <String>] [-Confirm]
